---
description: "Descarta um plano pendente de confirmação"
argument-hint: "<token>"
---

Chame a ferramenta `executar` do servidor MCP `copiloto` (plugin copiloto-operacional) com `linha` = `/cancelar $ARGUMENTS`.
