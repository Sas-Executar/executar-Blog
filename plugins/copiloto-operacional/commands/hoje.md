---
description: "Tarefas com data de hoje, atrasadas e WIP atual (fuso America/Sao_Paulo)"
allowed-tools: mcp__plugin_copiloto-operacional_copiloto__consultar
---

Chame a ferramenta `consultar` do servidor MCP `copiloto` (plugin copiloto-operacional) com `linha` = `/hoje`.
