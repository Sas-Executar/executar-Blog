/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bffdd66a48ef81a2d33c2202a4f63e92)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
	LIMITE: RateLimit;
	ASSETS: Fetcher;
	GITHUB_REPO: "Sas-Executar/executar-Blog";
	GITHUB_BRANCH: "main";
	BLOG_URL: "https://executar-blog.sas-executar.workers.dev";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPO" | "GITHUB_BRANCH" | "BLOG_URL">> {}
}
