/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bcf10edb852a1330a7e781fe7caf1faa)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
	LEDGER: D1Database;
	FILA: Queue;
	BROWSER: BrowserRun;
	OPS_REPO: "Sas-Executar/Copiloto";
	OPS_BRANCH: "claude/gifted-brown-7u1e5d";
	BLOG_REPO: "Sas-Executar/executar-Blog";
	EMAIL_FROM: "Copiloto EXECUTAR <copiloto@executar.local>";
	EMAIL_ENVIO_ATIVO: "0";
	GRAPH_MAILBOX: "";
	SHEETS_ID: "";
	URL_PUBLICA: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPS_REPO" | "OPS_BRANCH" | "BLOG_REPO" | "EMAIL_FROM" | "EMAIL_ENVIO_ATIVO" | "GRAPH_MAILBOX" | "SHEETS_ID" | "URL_PUBLICA">> {}
}
