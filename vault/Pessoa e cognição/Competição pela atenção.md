...
> 1. **Entender:** escolha uma situação real e descreva onde o esforço aparece.
> 2. **Estruturar:** selecione um controle diretamente ligado ao fator observado.
> 3. **Executar:** teste por um ciclo, compare sinais e registre o que mudou.
