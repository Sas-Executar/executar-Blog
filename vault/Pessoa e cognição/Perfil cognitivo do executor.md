...
```chart
type: bar
title: "Barreiras relatadas por tipo (dados fictícios)"
summary: "Distribuição ilustrativa (%) de barreiras relatadas por executores. Dados fictícios."
x: ["Memória", "Atenção", "Linguagem", "Organização"]
y: [35, 28, 15, 22]
height: 320
```
